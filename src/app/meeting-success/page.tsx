    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center p-4">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-xl text-gray-600 mb-8">
          Thank you for scheduling a meeting with our team. We're excited to discuss your business financing needs and help you find the perfect solution.
        </p>
          ...
          <div className="space-y-4 text-left">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">You'll receive a calendar invitation with meeting details shortly.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Our team will review your information and prepare personalized financing options.</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">We'll discuss your business goals and present tailored funding solutions.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-500">
            ...
            <Link href="/step/1" className="text-blue-600 hover:text-blue-800 underline ml-1">
