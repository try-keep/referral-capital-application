          ...
          <div className="container-large is-navbar back-light-2">
            <div className="navbar_component back-light-3">
              ...
              <div className="navbar_right-content-wrapper back-light-7">
                <a href="https://app.trykeep.com/login" aria-label="Log in" target="_blank" className="navbar_navlink w-nav-link">Log in</a>
                <a aria-label="Apply Now" href="/step/1" className="button hide-tablet back-light-8 w-inline-block">
                  <div>Apply Now</div>
                </a>
              </div>
              <div id="w-node-_497b9016-2905-0b50-62b6-c2f15a8cb717-7e3ea030" className="navbar_menu-button back-light-9 w-nav-button">
                ...
                <div className="header-capital-loan_padding-section">
                  <div className="w-layout-grid header-capital-loan_content">
                    <div className="header-capital-loan_content-left">
                      <img src="/images/trusted-by-seal-50K.svg" loading="lazy" alt="Trusted by 50,000+ Canadian Businesses" className="header-card_bbb-badge" />
                      <div className="spacer-large"></div>
                      <h1 className="heading-style-h2 text-color-gradient_yellow-pink-purple">2,000 Canadian Businesses choose Keep each month</h1>
                      <div className="spacer-small"></div>
                      <div className="heading-style-h3 text-weight-semibold">Business Loans - Fast, Flexible, Honest</div>
                      <div className="spacer-small"></div>
                      <div className="text-size-medium">We lend money at rates that aren't predatory... And if we can't finance your business ourselves, we have 30+ other lenders we partner with to get you there.</div>
                      ...
                      <div className="header-capital-loan_list-component">
                        <div className="header-capital-loan_item">
                          <div className="header-capital-loan_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 25" fill="none" className="icon-embed-xsmall">
                              <circle cx="12" cy="12.5762" r="11" fill="#4ABD87"></circle>
                              <path fillRule="evenodd" clipRule="evenodd" d="M12 1.57617C5.92487 1.57617 1 6.50104 1 12.5762C1 18.6513 5.92487 23.5762 12 23.5762C18.0751 23.5762 23 18.6513 23 12.5762C23 6.50104 18.0751 1.57617 12 1.57617ZM16.7682 10.7164C17.1218 10.2921 17.0645 9.66151 16.6402 9.30795C16.2159 8.95438 15.5853 9.0117 15.2318 9.43598L10.9328 14.5948L8.70711 12.3691C8.31658 11.9785 7.68342 11.9785 7.29289 12.3691C6.90237 12.7596 6.90237 13.3927 7.29289 13.7833L10.2929 16.7833C10.4916 16.9819 10.7646 17.0879 11.0453 17.0751C11.326 17.0624 11.5884 16.9322 11.7682 16.7164L16.7682 10.7164Z" fill="#CDF2E1"></path>
                            </svg>
                          </div>
                        ...
                        <div className="header-capital-loan_item">
                          ...
                          <p>Fair rates; As low as 8%, based on your business</p>
                        </div>
                        <div className="header-capital-loan_item">
                          <div className="header-capital-loan_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 24 25" fill="none" className="icon-embed-xsmall">
                    ...
                    <div className="header-capital-loan_image-wrapper">
                      <img sizes="(max-width: 1764px) 100vw, 1764px" 
                           ...
                           alt="" src="/images/cover.webp" loading="eager" className="header-capital-loan_image" />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="container-large">
                <div className="padding-section-large">
                  <div className="capital-why_component">
                    ...
                    <div className="spacer-small"></div>
                    <p className="text-size-medium text-color-secondary">One application - Multiple lenders. We give you the best deal, whether it's from Keep or another lender.</p>
                  </div>
                  ...
                  <div className="w-layout-grid capital-why_list">
                    <div className="capital-why_item">
                      <div className="capita-why_icon-wrapper">
                        <img src="/images/icon-honest_1icon-honest.webp" loading="lazy" alt="" className="capital-why_image" />
                      </div>
                      <div className="spacer-medium"></div>
                      <h3 className="heading-style-h4">We're making finance honest.</h3>
                      <div className="spacer-xsmall"></div>
                      <p className="text-color-secondary">We lend money at rates that aren't predatory</p>
                    </div>
                    <div className="capital-why_item">
                      <div className="capita-why_icon-wrapper">
                        <img src="/images/icon-application_1icon-application.webp" loading="lazy" alt="" className="capital-why_image" />
                      </div>
                      <div className="spacer-medium"></div>
                      <h3 className="heading-style-h4">One application, 30+ lenders</h3>
                      <div className="spacer-xsmall"></div>
                      <p className="text-color-secondary">If we can't finance you, we work with 30+ other lenders</p>
                    </div>
                    <div className="capital-why_item">
                      <div className="capita-why_icon-wrapper">
                        <img src="/images/icon-fees_1icon-fees.webp" loading="lazy" alt="" className="capital-why_image" />
                      </div>
                      <div className="spacer-medium"></div>
                      <h3 className="heading-style-h4">We don't charge fees</h3>
                      <div className="spacer-xsmall"></div>
                      <p className="text-color-secondary">We're not brokers. No loan origination fees.</p>
                    </div>
                    <div className="capital-why_item">
                      <div className="capita-why_icon-wrapper">
                        <img src="/images/icon-best-offer_1icon-best-offer.webp" loading="lazy" alt="" className="capital-why_image" />
                      </div>
                      <div className="spacer-medium"></div>
                      <h3 className="heading-style-h4">Best offer guarantee</h3>
                      <div className="spacer-xsmall"></div>
                      <p className="text-color-secondary">If our partners can offer you a better loan, we'll share their offer with you.</p>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div className="capital-works_wrapper">
                    <div className="z-index-1">
                      <div className="capital-works_component">
                        <h2 className="heading-style-h2">How it <span className="text-color-gradient_yellow-pink-purple">works</span></h2>
                        <div className="spacer-small"></div>
                        <p className="text-size-medium text-color-secondary">One application - Multiple lenders. We give you the best deal, whether it's from Keep or another lender.</p>
                      </div>
                      <div className="spacer-xxlarge"></div>
                      <div className="w-layout-grid capital-works_list">
                        <div className="capital-works_item">
                          <div className="card-works_image-wrapper">
                            <img loading="lazy" src="/images/offer-step-01_1offer-step-01.webp" alt="" className="card-benefits_icon" />
                          </div>
                          <div className="spacer-medium"></div>
                          <h3 className="heading-style-h4">Apply in Minutes</h3>
                          <div className="spacer-xsmall"></div>
                          <p className="text-color-secondary">Minimal paperwork required. Just some business details, and your recent bank statement.</p>
                        </div>
                        <div className="capital-works_item _02">
                          <div className="card-works_image-wrapper">
                            <img loading="lazy" src="/images/offer-step-02_1offer-step-02.webp" alt="" className="card-benefits_icon" />
                          </div>
                          <div className="spacer-medium"></div>
                          <h3 className="heading-style-h4">We review your loan</h3>
                          <div className="spacer-xsmall"></div>
                          <p className="text-color-secondary">We might get in touch if we need to know a little more about your business.</p>
                        </div>
                        <div className="capital-works_item _03">
                          <div className="card-works_image-wrapper">
                            <img loading="lazy" src="/images/offer-step-03_1offer-step-03.webp" alt="" className="card-benefits_icon" />
                          </div>
                          <div className="spacer-medium"></div>
                          <h3 className="heading-style-h4">Our partners review your loan</h3>
                          <div className="spacer-xsmall"></div>
                          <p className="text-color-secondary">Up to 30+ other lenders review your loan at same time.</p>
                        </div>
                        <div className="capital-works_item _04">
                          <div className="card-works_image-wrapper">
                            <img loading="lazy" src="/images/offer-step-04_1offer-step-04.webp" alt="" className="card-benefits_icon" />
                          </div>
                          <div className="spacer-medium"></div>
                          <h3 className="heading-style-h4">We surface the best offer to you</h3>
                          <div className="spacer-xsmall"></div>
                          <p className="text-color-secondary">Even if it not us financing your business, we will always give you the best offer.</p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="container-large">
                <div className="padding-section-large padding-top">
                  <div className="capital-solutions_component">
                    <h2 className="heading-style-h2">One platform<br /><span className="text-color-gradient_yellow-pink-purple">A range of funding solutions</span></h2>
                  </div>
                  <div className="spacer-xxlarge"></div>
                  <div className="w-layout-grid capital-solutions_row">
                    <div className="capital-solutions_card">
                      <div className="capital-solutions_card-content">
                        ...
                        <div className="spacer-xsmall"></div>
                        <p className="text-color-secondary">One off lump sum for big or small business plans. From $5K to $1.5M.</p>
                      </div>
                      <div className="capital-solutions_card-image-wrapper">
                        <img sizes="(max-width: 832px) 100vw, 832px" 
                             ...
                             alt="" src="/images/industries-features_00001.webp" loading="lazy" className="capital-solutions_card-image" />
                        <a href="/step/1" className="capital-solutions_button hide-mobile-landscape w-button">Apply</a>
                      </div>
                    </div>
                    <div className="capital-solutions_card">
                      <div className="capital-solutions_card-content">
                        ...
                        <div className="spacer-xsmall"></div>
                        <p className="text-color-secondary">Ongoing access to funds with interest only paid on what you use, and no monthly or annual fees.</p>
                      </div>
                      <div className="capital-solutions_card-image-wrapper">
                        <img sizes="(max-width: 832px) 100vw, 832px" 
                             srcSet="/images/industries-features_00002-p-500.webp 500w, /images/industries-features_00002.webp 832w" 
                             alt="" src="/images/industries-features_00002.webp" loading="lazy" className="capital-solutions_card-image" />
                        <a href="/step/1" className="capital-solutions_button hide-mobile-landscape w-button">Apply</a>
                      </div>
                    </div>
                    <div className="capital-solutions_card">
                      ...
                      <div className="capital-solutions_card-image-wrapper">
                        <img sizes="(max-width: 832px) 100vw, 832px" 
                             ...
                             alt="" src="/images/industries-features_00003.webp" loading="lazy" className="capital-solutions_card-image" />
                        <a href="/step/1" className="capital-solutions_button hide-mobile-landscape w-button">Apply</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="capital-faq_component">
                    <div className="capital-faq_sidebar">
                      <div className="capital-faq_sidebar-heading">
                        <div className="heading-style-h5 text-weight-bold">Jump to Question</div>
            ...
            <div className="padding-section-large">
              <div className="senja_component">
                  ...
                  <div className="text-align-center">
                    <div className="max-width-large align-center">
                      <div className="title-rich-text w-richtext">
                        <h2>Canadian Businessses <strong>Love Keep</strong></h2>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-embed w-script">
                  <Script src="https://widget.senja.io/widget/2e9a638c-e8dd-42fe-be3d-fc791332df87/platform.js" strategy="afterInteractive" />
                  <div className="senja-embed" data-id="2e9a638c-e8dd-42fe-be3d-fc791332df87" data-mode="shadow" data-lazyload="false" style={{display: 'block', width: '100%'}}></div>
                </div>
              </div>
            </div>
          </section>
                ...
                <div className="padding-xxlarge padding-bottom">
                  ...
                  <div className="w-layout-grid footer_top-wrapper">
                    <div className="footer_content-wrapper">
                      ...
                      <div className="spacer-small"></div>
                      <div className="text-size-small text-color-disabled">
                        Contact us at <a href="mailto:support@trykeep.com" className="footer_credit-link">support@trykeep.com</a><br />
                        For inquiries call/text <a href="tel:18664605337" className="footer_credit-link">+1-866-460-5337</a><br />
                        51 Wolseley St. Toronto, ON M5T 1A5
                      </div>
                    </div>
                    <div className="footer_link-list">
                      <div className="text-size-small">Explore</div>
                      <a href="https://www.trykeep.com/" target="_blank" className="footer_link">Home</a>
                      <a href="https://help.trykeep.com/" target="_blank" className="footer_link">Help Centre</a>
                      <a href="tel:+18664605337" className="footer_link">Call Us</a>
                      <a href="https://www.trykeep.com/careers" target="_blank" className="footer_link">Jobs</a>
                      <a href="https://www.trykeep.com/media-coverage" target="_blank" className="footer_link">Media Coverage</a>
                      <a href="https://www.trykeep.com/newsroom" target="_blank" className="footer_link">Blog</a>
                      <a href="https://www.trykeep.com/legal/platform-agreement" target="_blank" className="footer_link">Legal</a>
                      <a href="/step/1" className="footer_link">Apply Today</a>
                    </div>
                  </div>
                </div>
                ...
                <div className="padding-top padding-medium">
                  <div className="footer_bottom-wrapper">
                    <div className="w-layout-grid footer2_social-list">
                      <a aria-label="x" href="https://x.com/Keep_Card" target="_blank" className="footer2_social-link w-inline-block">
                      ...
                      <a aria-label="linkedin" href="https://www.linkedin.com/company/trykeep/" target="_blank" className="footer2_social-link w-inline-block">
                        <svg fill="none" viewBox="0 0 800 800" width="100%" className="icon-1x1-regular">
                          <path fill="currentColor" fillRule="evenodd" d="M672 672H563.2V481.627c0-52.224-23.038-81.361-64.355-81.361-44.962 0-71.645 30.361-71.645 81.361V672H318.4V318.4h108.8v39.764s34.136-59.898 111.057-59.898C615.206 298.266 672 345.222 672 442.38V672ZM194.422 261.848c-36.692 0-66.422-29.972-66.422-66.937C128 157.973 157.73 128 194.422 128c36.666 0 66.395 29.973 66.395 66.911.028 36.965-29.729 66.937-66.395 66.937ZM128 672h136V318.4H128V672Z" clipRule="evenodd"></path>
                        </svg>
                      </a>
                      <a aria-label="instagram" href="https://www.instagram.com/keep_hq/" target="_blank" className="footer2_social-link w-inline-block">
                        <div className="icon-1x1-regular w-embed">
                          <svg width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <a aria-label="facebook" href="https://www.facebook.com/people/Keep/100080028222444/" target="_blank" className="footer2_social-link w-inline-block">
                        <svg fill="none" viewBox="0 0 800 800" width="100%" className="icon-1x1-regular">
                          <path fill="currentColor" d="m578 71.07-98.902-.12c-95.911 0-157.867 63.541-157.867 161.994v74.641H222v135.07h99.231l-.119 286.446h138.84l.119-286.446h113.86l-.089-135.04H460.071v-63.332c0-30.455 7.21-45.862 46.849-45.862l70.781-.03L578 71.069Z"></path>
                        </svg>
                      </a>
                    </div>
                    <div className="w-layout-grid footer_social-list">
                      <div className="footer_credit-text"><strong>©</strong>2025 Keep Technologies Corp. All rights reserved</div>
                      <a href="https://www.trykeep.com/legal/privacy-policy" target="_blank" className="footer_credit-link">Privacy Policy</a>
                      <a href="https://www.trykeep.com/legal/website-terms" target="_blank" className="footer_credit-link">Terms of Service</a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="button-group is-center z-index-999">
            <div className="card-cta center">
              <div className="card-cta_wrapper center-2">
                <a href="/step/1" className="button is-xlarge center-3 w-button">Apply in Minutes</a>
              </div>
              <div className="spacer-xsmall center-5"></div>
              <p className="text-size-small text-color-secondary center-6">Applications do not impact your credit score<sup>1</sup></p>
            </div>
          </div>
