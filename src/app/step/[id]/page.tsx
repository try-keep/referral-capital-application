...
function Step12Form({
  ...
  // Handle development continue button click
  const handleDevContinue = () => {
    const connectionData = {
      ...localData,
      bankConnectionCompleted: 'true',
      loginId: 'dev-login-id',
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-8">
      ...
      {/* Show development message if NEXT_PUBLIC_SKIP_FLINKS is true */}
      {skipFlinks ? (
        <div className="text-center">
          <div className="mb-6 p-6 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <p className="text-yellow-700 mb-4">
              This is a development environment and we will not be actually
              requesting Flinks data. This message will not show up in
              production.
            </p>
          </div>
            ...
            <div className="text-center">
              <div className="mb-6 p-6 bg-green-50 border border-green-200 rounded-lg">
                ...
                <p className="text-green-600 mb-4">
                  Your business bank account has been successfully connected.
                  Your banking information is securely stored and ready for
                  processing.
                </p>
              </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      ...
                      cannot see your login credentials.
                    </p>
                  </div>
                </div>
              </div>
