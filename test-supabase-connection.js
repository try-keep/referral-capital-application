...
async function testSupabaseConnection() {
  ...
  try {
    ...
    console.log(
      `✅ Applications table accessible (${appData.count || 0} records)`
    );
    ...
    console.log(
      `✅ Businesses table accessible (${bizData.count || 0} records)`
    );
    ...
    await supabase.from('businesses').delete().eq('mras_id', 'TEST123');
