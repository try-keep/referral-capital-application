...
async function testBusinessWorkflow() {
  ...
  try {
    ...
    console.log(
      `✅ Businesses table exists (${businessCheck.length || 0} records)`
    );
    ...
    console.log(
      `📊 Computed business age: ${savedBusiness.business_age_category}`
    );
    console.log(
      `🏢 Estimated business type: ${savedBusiness.estimated_business_type}`
    );
    ...
    const testApplication = {
      ...
      business_type:
        savedBusiness.estimated_business_type || 'professional-services',
    ...
    console.log(
      `   https://app.supabase.com/project/gtogvkaukyxxwvxenfit/editor`
    );
  } catch (error) {
