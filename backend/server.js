...
app.get('/api/health', (req, res) => {
  res.json({
    status: 'OK',
    message: 'Referral Capital Application API is running',
  });
});
...
app.post('/api/applications', (req, res) => {
  try {
    ...
    console.log(
      `New application submitted: ${application.id} - ${application.businessName}`
    );
...
app.listen(PORT, () => {
  console.log(
    `🚀 Referral Capital Application API server running on port ${PORT}`
  );
