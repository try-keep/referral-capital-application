-- Supabase Table Setup for Referral Capital Application
...
-- Optional: Add a policy for updates if needed later
-- CREATE POLICY "Allow updates" ON applications
--   FOR UPDATE USING (true) WITH CHECK (true);

-- Verify the setup
SELECT 'Setup complete! Applications table created with RLS policies.' as status;